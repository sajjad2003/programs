...
public class XAExample {
	...
	public static final String QM_NAME = "COORD_WA00253E";
	...
	public static void initialize() throws Exception {
		...
		theQueueManager = new MQQueueManager("COORD_WA00253E", properties);
		...
		PoolXADataSource xads = PoolDataSourceFactory.getPoolXADataSource();

		xads.setConnectionFactoryClassName("oracle.jdbc.xa.client.OracleXADataSource");
		xads.setURL("jdbc:oracle:thin:@//wa00253e:1521/XE");
		xads.setUser("mqxa");
		xads.setPassword("mqxa123");
	...
	public static void runTransaction() {
		...
		try {
			...
			PreparedStatement stmt = theDatabaseConnection
					.prepareStatement("INSERT INTO  mqxajava VALUES (?,?)");
			// update the time
